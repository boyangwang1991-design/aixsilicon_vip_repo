...
`Developing`（当前仅 `docs/` 就绪：需求 G0（0.4.0-draft，对齐模板 27 章：含能力模型/External Interface/Transaction Model/Statistics 等）/ 架构 G1 输入；`src/` 源码与 Self Test 待开发）
...
| 交付物 | 路径 | 状态 |
| --- | --- | --- |
| 需求规格 | `docs/requirement.md` | ✅ G0（0.4.0-draft） |
